class GetSingleProductResturant {
  int? status;
  bool? error;
  Messages? messages;

  GetSingleProductResturant({this.status, this.error, this.messages});

  GetSingleProductResturant.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    error = json['error'];
