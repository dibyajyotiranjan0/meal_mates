...
class MyPrfileScreeen extends StatefulWidget {
  const MyPrfileScreeen({super.key});

  @override
  State<MyPrfileScreeen> createState() => _MyPrfileScreeenState();
}

class _MyPrfileScreeenState extends State<MyPrfileScreeen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<ViewProfileResturantProvider>(
            builder: (context, vap, child) {
          return vap.profile_resturant != null
              ? Form(
                  key: formKey,
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: _image != null
                                  ...
                                  : Image.network(
                                      "https://collegeprojectz.com/mealmate/uploads/${vap.profile_resturant!.messages!.status!.userdata![0].profileImage}",
                                      errorBuilder:
